#!/usr/bin/env python3
"""Fail if anything under src/agentguard imports outside the standard library.
...
ROOT = Path(__file__).resolve().parent.parent / "src" / "agentguard"
ALLOWED = set(sys.stdlib_module_names) | {"agentguard"}
