...
*any* other non-zero exit. Only a timeout fails open. That is why `agentguard`
...
from agentguard.events import Decision, HookEvent
from agentguard.providers.base import EmitResult, ProviderAdapter, block_stop_json
