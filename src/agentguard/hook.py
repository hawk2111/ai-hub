...
crash in agentguard would not merely fail to guard a Copilot run, it would lock
...
from agentguard.handlers import build_runtime, route
from agentguard.providers import detect
